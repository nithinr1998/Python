...
pubname1=str(input("Enter the Publiser :"))linr
author1=str(input("Enter the Autor :"))
price1=str(input("Enter the price :"))
page1=str(input("Enter no of Pages :"))

b1 = Python(pubname1, title1, author1, price1, page1)
b1.display()
